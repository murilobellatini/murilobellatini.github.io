...
My data toolkit covers the whole **Machine Learning Pipeline** with Data Collection, Wrangling, Cleaning, Visualization, Feature Engineering, **Predictive Model Training & Testing** — in **Python**. Currently, the areas of greatest interest to me tackle unstructured data problems such as Natural Language Processing and Speech Recognition, especially regarding **Unsupervised Deep Learning**.
